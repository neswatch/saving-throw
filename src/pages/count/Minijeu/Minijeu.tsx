  ...
  return (
    <div>
      ...
      <p>
        ...
        de même pour l'océan
      </p>
      <p>
        Les courants marins sont tels nos vaisseaux sanguins. Les ressources de
        l'océan transitent en permanence grâce eux
      </p>
      <p>
        S'ils disparaissent, c'est alors tout l'océan qui est en danger. La
        chaine alimentaire d'en voit boulversée
      </p>
      <p>
        A vous de jouer, soyez comme le coeur de l'océan, retablissez l'ordre
        dans ce véritbale circuit maritime
      </p>
      <p>
